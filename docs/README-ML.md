...
- **`.github/workflows/vhd-bridge.yml`** &mdash; feature-on / feature-off / controlled-only Windows ആർട്ടിഫാക്റ്റുകൾ ബിൽഡ് ചെയ്യുന്ന CI matrix.
...
2. **CI** &mdash; അതേ പേരുകൾ GitHub Actions repository secrets ആയി കോൺഫിഗർ ചെയ്യുക; [`.github/workflows/vhd-bridge.yml`](../.github/workflows/vhd-bridge.yml) അവയെ മാസ്ക് ചെയ്ത env വേരിയബിളുകളായി inject ചെയ്യുന്നു. **`secret.sec` runners-ൽ ഒരിക്കലും materialize ചെയ്യില്ല**.
